...
public class ChatServiceImpl implements ChatService {
    ...
    private ChatExtractionResultDto parseResponse(String responseJson) throws JsonProcessingException {
        try {
    ...
    @Override
    @Transactional
    public ConversationResponseDto continueConversation(UUID memberId, ConversationRequestDto request) {
        String sessionId = request.getSessionId();
        ...
        ChatSession session = chatSessionRepository.findBySessionIdAndIsActiveTrue(sessionId)
                .orElseThrow(() -> new IllegalArgumentException("활성화된 세션을 찾을 수 없습니다: " + sessionId));
        ...
        try {
            ...
            // AI 응답 저장
            ChatHistory botMessage = saveConversationMessage(sessionId, memberId, aiResponse, "BOT");
            ...
            ChatHistory botMessage = saveConversationMessage(sessionId, memberId, errorResponse, "BOT");
    ...
    private ChatHistory saveConversationMessage(String sessionId, UUID memberId, String message, String messageType) {
    ...
    private String buildConversationContext(List<ChatHistory> sessionHistory, String currentMessage) {
        ...
        sessionHistory.stream()
                .forEach(history -> {
                    ...
                    } else if ("BOT".equals(history.getMessageType()) && history.getResponse() != null) {
